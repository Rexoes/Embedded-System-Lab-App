...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	uint16_t GPIO_PINS = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7;
  /* USER CODE END 1 */
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	 if(HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_13) == GPIO_PIN_SET){
		 HAL_GPIO_WritePin(GPIOE, GPIO_PINS, GPIO_PIN_RESET);
	 }
	 else{
		 HAL_GPIO_WritePin(GPIOE, GPIO_PINS, GPIO_PIN_SET);
	 }
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
